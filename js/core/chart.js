...
// "Stitches" component set (mSct8t0TpsyYJad4teKfwl, node 1:258), exported
// at native 24x24 and re-rendered at a small fixed size here — the SVG
// viewBox scales the path automatically, so no coordinates were hand-
// converted. `currentColor` replaces the export's hardcoded fill/stroke so
// the existing active-row color swap (.crow-active .cc-sym) keeps working.
// ─────────────────────────────────────────────
const SYMS = {
  P:   '<svg width="8" height="8" viewBox="0 0 24 24" style="display:block"><rect x="8" y="8" width="8" height="8" rx="4" fill="currentColor"/></svg>',
  YO:  '<svg width="9" height="9" viewBox="0 0 24 24" style="display:block"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20ZM12.0001 17.7143C15.156 17.7143 17.7143 15.1559 17.7143 12C17.7143 8.84408 15.156 6.28571 12.0001 6.28571C8.84414 6.28571 6.28577 8.84408 6.28577 12C6.28577 15.1559 8.84414 17.7143 12.0001 17.7143Z" fill="currentColor"/></svg>',
  K2:  '<svg width="9" height="9" viewBox="0 0 24 24" style="display:block"><path d="M20 4V20H4L20 4Z" fill="currentColor"/></svg>',
  SK:  '<svg width="9" height="9" viewBox="0 0 24 24" style="display:block"><path d="M4 4V20H20L4 4Z" fill="currentColor"/></svg>',
  M1:  '<svg width="10" height="10" viewBox="0 0 24 24" style="display:block"><path d="M11.999 6.97318C12.7329 6.49387 13.8686 5.87939 14.8271 5.38138C15.3191 5.12575 15.7663 4.9004 16.0898 4.7388C16.2514 4.65811 16.3821 4.59298 16.4727 4.54837C16.5179 4.52609 16.5533 4.50929 16.5771 4.49759C16.5891 4.49174 16.5984 4.48692 16.6045 4.48392L16.709 4.43314L17.2227 5.65677L17.1738 5.78568L17.1426 5.80032C17.1221 5.81024 17.0916 5.8253 17.0527 5.84427C16.975 5.88217 16.8625 5.93682 16.7236 6.0054C16.4454 6.14285 16.0606 6.33479 15.6357 6.55228C14.8368 6.96131 13.899 7.46106 13.2549 7.85892C14.279 8.63071 15.3451 9.56084 16.165 10.6411C17.0167 11.7633 17.6074 13.0524 17.6074 14.4947C17.6072 17.585 15.0967 20.0894 12 20.0894C8.90325 20.0894 6.3928 17.585 6.39258 14.4947C6.39258 13.0526 6.98335 11.7634 7.83496 10.6411C8.6543 9.56139 9.71884 8.63136 10.7422 7.85989C10.2488 7.56159 9.33357 7.07321 8.50781 6.64505C8.05834 6.412 7.63692 6.19637 7.32812 6.03958C7.17393 5.96129 7.04756 5.89723 6.95996 5.85306C6.91646 5.83112 6.88253 5.81392 6.85938 5.80228L6.82617 5.78568L6.82324 5.7847L6.74023 5.74271L7.24805 4.52884L7.38477 4.47806L7.39453 4.48294C7.40094 4.48612 7.41056 4.49148 7.42285 4.49759C7.44775 4.50997 7.4844 4.5279 7.53125 4.5513C7.6256 4.59843 7.76217 4.66687 7.92969 4.7515C8.26463 4.9207 8.72451 5.15583 9.22559 5.41751C10.1988 5.92575 11.3316 6.53872 11.999 6.97318ZM11.999 8.69876C11.0694 9.36548 10.0335 10.1885 9.22461 11.1509C8.39846 12.134 7.81641 13.2546 7.81641 14.4947C7.81663 16.7996 9.68926 18.6685 12 18.6685C14.3107 18.6685 16.1834 16.7996 16.1836 14.4947C16.1836 13.2546 15.6015 12.134 14.7754 11.1509C13.9662 10.188 12.929 9.36564 11.999 8.69876Z" fill="currentColor" stroke="currentColor" stroke-width="0.2"/></svg>',
  M1L: '<svg width="10" height="10" viewBox="0 0 24 24" style="display:block"><path d="M18 21L18 3M4 3L17.9642 11.0623" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none"/></svg>',
  M1R: '<svg width="10" height="10" viewBox="0 0 24 24" style="display:block"><path d="M6 21L6 3M6 11L19.9642 2.93774" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none"/></svg>',
};
