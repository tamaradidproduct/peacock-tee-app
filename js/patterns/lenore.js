...
const LENORE_PHASES = [
  ...
  },
  {
    ...
    steps:[
      ...
      {id:'r1-def-ghi2', text:'Ring D – Chain I (repeat unit):',
        ...
        rows:true, target:2, lbl:'repeat: Ring D – Chain I'},
      {id:'r1-d2', text:'Ring D: 2 - 2 + 2 - 2 - 2 (join to the previous repeat) — final point, stop after Ring H (no Chain I this time)'},
      {id:'r1-e2', text:'Ring E: 2 + 2 - 1 --- 1 - 2 - 2 (join to Ring D)'},
      {id:'r1-f2', text:'Ring F: 2 - + 2 - 2 - 2 - 2 (join to Ring E)'},
      {id:'r1-g2', text:'Chain G: 4 - 2 - 2 - 2'},
      {id:'r1-h2', text:'Ring H: 2 + 2 - 2 (join to Ring F)'},
  ...
  },
  {
    ...
    steps:[
      ...
      {id:'r2-fghijklm', text:'Turn the corner:',
        bullets:[
          'Chain F: 6',
          'Ring G: 6 + 2 + 4 - 2 (join to last Ring D, join to Ring O of Row 1)',
          'Ring H: 2 + 4 - 4 (join to Ring G)',
          'Chain I: 4',
          'Ring J: 4 + 2 - 2 - 2 (join to Ring H)',
          'Ring K: 2 + 4 - 1 --- 1 - 4 - 2 (join to Ring J)',
          'Ring L: 2 + 2 - 2 - 4 (join to Ring K)',
          'Chain M: 6',
        ]},
      ...
      {id:'r2-tuvxy', text:'Tie off section:',
        bullets:[
          'Chain T: 6',
          'Ring U: 4 + 2 - 2 - 2 (join to last Ring N)',
          'Ring V: 2 + 4 - 1 --- 1 - 4 - 2 (join to Ring U)',
          'Ring X: 2 + 2 - 2 + 4 (join to Ring A)',
          'Chain Y: 4 — tie off at the base of Ring A and hide ends',
        ]},
    ]
  },
  {
